...
public class NotificationHandler {
    private static final String CHANNEL_ID = "furniture_shop_notification_channel";
    ...
    public void send(String message) {
        Intent intent = new Intent(mContext, FurnitureListActivity.class);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext, CHANNEL_ID)
                .setContentTitle("Furniture Shop")
                .setContentText(message)
                .setSmallIcon(R.drawable.circle_notification)
